...
@property (nonatomic, copy, nullable) void(^successBlock)(id <VVGroupChildRequestProtocol> _Nonnull request);

/// the childRequest failure block
@property (nonatomic, copy, nullable) void(^failureBlock)(id <VVGroupChildRequestProtocol> _Nonnull request);
